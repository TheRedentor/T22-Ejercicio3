...
public class Vista extends JFrame {
	...
	public JTextField dni_cientifico_antiguo;
	public JTextField id_proyecto_antiguo;
	public JButton boton_salir_delete_cientifico;
	public JButton boton_salir_update_cientifico;
	public JButton boton_salir_create_cientifico;
	public JButton boton_salir_update_asignado;
	public JButton boton_salir_delete_asignado;
	public JButton boton_salir_create_asignado;
	...
	public Vista() {
		...
		boton_salir_create_cientifico = new JButton("Salir");
		boton_salir_create_cientifico.setBounds(394, 446, 89, 23);
		vista_create_cientifico.add(boton_salir_create_cientifico);
		...
		boton_salir_update_cientifico = new JButton("Salir");
		boton_salir_update_cientifico.setBounds(425, 398, 89, 23);
		vista_update_cientifico.add(boton_salir_update_cientifico);
		...
		boton_salir_delete_cientifico = new JButton("Salir");
		boton_salir_delete_cientifico.setBounds(388, 400, 89, 23);
		vista_delete_cientifico.add(boton_salir_delete_cientifico);
		...
		boton_salir_create_asignado = new JButton("Salir");
		boton_salir_create_asignado.setBounds(404, 433, 89, 23);
		vista_create_asignado_a.add(boton_salir_create_asignado);
		...
		JLabel lblDniCambio = new JLabel("DNI Cientifico");
		lblDniCambio.setBounds(461, 44, 99, 14);
		vista_delete_asignado_a.add(lblDniCambio);
		...
		JLabel lblIdProyectoCambio = new JLabel("ID Proyecto");
		lblIdProyectoCambio.setBounds(461, 103, 99, 14);
		vista_delete_asignado_a.add(lblIdProyectoCambio);
		...
		boton_salir_delete_asignado = new JButton("Salir");
		boton_salir_delete_asignado.setBounds(362, 411, 89, 23);
		vista_delete_asignado_a.add(boton_salir_delete_asignado);
		...
		label18.setBounds(361, 30, 115, 14);
		...
		label19.setBounds(361, 86, 115, 14);
		...
		dni_cientifico_antiguo = new JTextField();
		dni_cientifico_antiguo.setBounds(361, 173, 86, 20);
		vista_update_asignado_a.add(dni_cientifico_antiguo);
		dni_cientifico_antiguo.setColumns(10);
		
		id_proyecto_antiguo = new JTextField();
		id_proyecto_antiguo.setBounds(361, 226, 86, 20);
		vista_update_asignado_a.add(id_proyecto_antiguo);
		id_proyecto_antiguo.setColumns(10);
		
		JLabel lblNewLabel_2 = new JLabel("DNI Antiguo");
		lblNewLabel_2.setBounds(361, 148, 133, 14);
		vista_update_asignado_a.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Id Proyecto Antiguo");
		lblNewLabel_3.setBounds(361, 201, 115, 14);
		vista_update_asignado_a.add(lblNewLabel_3);
		
		boton_salir_update_asignado = new JButton("Salir");
		boton_salir_update_asignado.setBounds(415, 408, 89, 23);
		vista_update_asignado_a.add(boton_salir_update_asignado);
		...
		boton_salir_create_proyecto = new JButton("Salir");
		boton_salir_create_proyecto.setBounds(395, 433, 89, 23);
		vista_create_proyecto.add(boton_salir_create_proyecto);
		...
		boton_salir_delete_proyecto = new JButton("Salir");
		boton_salir_delete_proyecto.setBounds(386, 384, 89, 23);
		vista_delete_proyecto.add(boton_salir_delete_proyecto);
		...
		boton_salir_update_proyecto = new JButton("Salir");
		boton_salir_update_proyecto.setBounds(427, 387, 89, 23);
		vista_update_proyecto.add(boton_salir_update_proyecto);
