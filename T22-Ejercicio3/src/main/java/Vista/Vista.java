...
public class Vista extends JFrame {
	...
	public Vista() {
		...
		createDniField.setBounds(77, 83, 86, 20);
		...
		createNomApelsField.setBounds(77, 151, 86, 20);
		...
		boton_guardar_cientifico.setBounds(94, 376, 124, 46);
		...
		editDniField.setBounds(37, 55, 86, 20);
		...
		editNomApelsField.setBounds(37, 111, 86, 20);
		...
		boton_guardar1_cientifico.setBounds(91, 299, 147, 73);
		...
		textAreaCientifico.setBounds(20, 0, 315, 289);
		vista_read_cientifico.add(textAreaCientifico);
		
		boton_salir_cientifico = new JButton("Salir");
		boton_salir_cientifico.setBounds(97, 299, 147, 73);
		...
		deleteDniField.setBounds(196, 55, 86, 20);
		vista_delete_cientifico.add(deleteDniField);
		
		boton_borrar_cientifico = new JButton("Borrar");
		boton_borrar_cientifico.setBounds(97, 299, 147, 73);
		...
		lblNewLabel_15.setBounds(141, 25, 91, 14);
		vista_create_proyecto.add(lblNewLabel_15);
		
		JSeparator separator1 = new JSeparator();
		separator1.setBounds(10, 11, 40, 406);
		...
		textAreaProyecto.setBounds(20, 0, 315, 289);
		vista_read_proyecto.add(textAreaProyecto);
		
		boton_salir_proyecto = new JButton("Salir");
		boton_salir_proyecto.setBounds(97, 299, 147, 73);
		...
		label_id_12.setBounds(196, 30, 46, 14);
		...
		boton_borrar_proyecto.setBounds(97, 299, 147, 73);
		...
		createCientificoDniField.setBounds(77, 83, 86, 20);
		...
		lblNewLabel_16.setBounds(77, 58, 46, 14);
		vista_create_asignado_a.add(lblNewLabel_16);
		
		createProyectoIdField = new JTextField();
		createProyectoIdField.setBounds(77, 151, 86, 20);
		...
		lblNewLabel_18.setBounds(141, 25, 91, 14);
		vista_create_asignado_a.add(lblNewLabel_18);
		
		JSeparator separator2 = new JSeparator();
		separator2.setBounds(10, 11, 40, 406);
		...
		editCientificoDniField.setBounds(37, 55, 86, 20);
		...
		textAreaAsignadoA.setBounds(20, 0, 315, 289);
		vista_read_asignado_a.add(textAreaAsignadoA);
		
		boton_salir_asignado_a = new JButton("Salir");
		boton_salir_asignado_a.setBounds(97, 299, 147, 73);
